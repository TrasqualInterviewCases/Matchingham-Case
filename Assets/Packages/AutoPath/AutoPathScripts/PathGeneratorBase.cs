...
public abstract class PathGeneratorBase : MonoBehaviour
{
    ...
    {
        return pathCreator.path.GetPointAtDistance(pathLenght, EndOfPathInstruction.Stop);
    }

    public virtual Quaternion GetEndRotation()
    {
        return pathCreator.path.GetRotationAtDistance(pathLenght, EndOfPathInstruction.Stop);
    }
}
